...
public class MenuStudent extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MenuStudent frame = new MenuStudent(args[0], args[1]);
	...
	public MenuStudent(String a, String b ) {
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(26)
					.addComponent(desktopPane, GroupLayout.PREFERRED_SIZE, 530, GroupLayout.PREFERRED_SIZE)
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ViewOneStudent studentDetails = new ViewOneStudent(a, b);
				studentDetails.show();
				dispose();
		...
		JButton btnNewButton_1 = new JButton("Change the password");
		btnNewButton_1.setForeground(Color.BLACK);
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				UpdatePass update = new UpdatePass(a, b);
				update.show();
				dispose();
		...
		btnNewButton_1.setBounds(32, 110, 287, 52);
